...
class mapbox {
	...
	public function _create_layer_owm()
	{
		...
		$layer->data = array(
			'baselayer' => FALSE,
			'attribution' => '',
			'url' => 'http://undefined.tile.openweathermap.org/map/snow/${z}/${x}/${y}.png',
			'type' => ''
		);
	...
	{
		$js = Event::$data;
		//attempts to add overlays
		$this->layers = $this->_create_layer_owm();
